...
## 목적
§11-6 의 화면들을 구현. 각 화면은 `implement-one-screen` 절차를 따른다.

## 선행조건
- 직전 Step COMPLETED.

## 참조파일
- `.claude/spec/04_gravit_admin_frontend_spec.md` §11-6, §10(상세동작), §12(해당 Step 프롬프트)
...
## 출력
- 해당 §11-6 완료기준 충족(각 화면 4상태 + 상호작용 동작).
